...
export class GitLabClient {
  ...
  async postReview(projectId: string, mergeRequestId: string, approvalPassword?: string): Promise<void> {
  ...
  async postComment(projectId: string, mergeRequestId: string, comment: string): Promise<void> {
